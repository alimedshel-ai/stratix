...
router.post('/:userId/memberships', verifyToken, async (req, res) => {
  try {
...
router.patch('/:userId/memberships/:membershipId', verifyToken, async (req, res) => {
  try {
...
// Remove user from entity (delete membership)
router.delete('/:userId/memberships/:membershipId', verifyToken, async (req, res) => {
  try {
    const { membershipId } = req.params;
