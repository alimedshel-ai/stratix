...
router.post('/', verifyToken, async (req, res) => {
    try {
        const { title, description, versionId, status, priority } = req.body;
...
// Create risk
router.post('/risks', verifyToken, async (req, res) => {
    try {
        const { title, description, versionId, choiceId, probability, impact, mitigation, owner, status } = req.body;
...
// Update risk
router.patch('/risks/:id', verifyToken, async (req, res) => {
    try {
        const { title, description, probability, impact, mitigation, owner, status, choiceId } = req.body;
...
// Delete risk
router.delete('/risks/:id', verifyToken, async (req, res) => {
    try {
