...
window.SmartGuide = (function () {
    ...
    function render(containerId, dashboardType) {
        ...
        try {
            const dp = JSON.parse(localStorage.getItem('stratix_diagnostic_payload') || '{}');
            diagRole = dp.role || '';
        } catch (e) { }
        ...
        try { hasObjectives = JSON.parse(localStorage.getItem('objectives') || '[]').length > 0; } catch (e) { }
        try { hasKPIs = JSON.parse(localStorage.getItem('kpis') || '[]').length > 0; } catch (e) { }
        try {
        ...
        try {
            const deptData = JSON.parse(localStorage.getItem('stratix_dept_deep_payload') || '{}');
