    ...
    pain: {
      no_strategy: {
        ...
        points: [
          ...
          'الخبر الحلو: ستارتكيس راح يساعدك تبني خطة خطوة بخطوة'
        ],
      ...
      no_measurement: {
        ...
        points: [
          ...
          'ستارتكيس يعطيك Dashboard لحظي يوريك صحة شركتك'
        ],
      ...
      plan_vs_execution: {
        ...
        points: [
          ...
          'نظام التنفيذ في ستارتكيس يربط الأهداف بالمهام اليومية'
        ],
      ...
      team_alignment: {
        ...
        points: [
          ...
          'ستارتكيس يوزّع الأهداف على الإدارات ويربط الكل برؤية واحدة'
        ],
      ...
      market_pressure: {
        ...
        points: [
          ...
          'ستارتكيس يساعدك تكتشف التهديدات قبل ما توصلك'
        ],
      ...
      growth_stuck: {
        ...
        points: [
          ...
          'ستارتكيس يعطيك أدوات التشخيص المناسبة لوضعك'
        ],
    ...
    amb: {
      clear_strategy: {
        ...
        points: [
          ...
          'ستارتكيس يمشيك بالترتيب — ما تحتاج تضيع وقت تفكر وش الخطوة'
        ],
      ...
      execution_machine: {
        ...
        points: [
          ...
          'ستارتكيس يتابع التأخيرات ويطلق تنبيهات تلقائية'
        ],
